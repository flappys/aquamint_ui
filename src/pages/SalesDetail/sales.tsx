...
import GridContentItem from "../../shared/components/gridcontent/GridContentItem";
            ...
            <div className="ml-20 md:w-[40%] flex flex-col items-start">
              ...
              <div className={`w-[100%] mt-5 overflow-hidden`}>
                ...
                >
                  ...
                  <p className="px-4 py-5 font-Montserrat-Light text-[12px]">{data?.meta?.description}</p>
                </div>
              </div>
              ...
              >
                ...
                <p className="px-8 py-5 font-Montserrat-Light text-[12px]">{data?.meta?.description}</p>
              </div>
                        ...
                        <tbody className="">
                          {nft_details_table.map((data: any, index: any) => (
                            <tr className="custom-border-t" key={index}>
                              <td className="font-Montserrat-Light text-[12px] py-4 whitespace-nowrap">
                                {data.event}
                              </td>
                              <td className="font-Montserrat-Light text-[12px] py-4 whitespace-nowrap">
                                {data.price}
