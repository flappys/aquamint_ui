...
function FeaturedHome(props: any) {
  ...
  return <>{props.data.length!=0 ? <div className="grid grid-cols-2 sm:grid-cols-1 xs:grid-cols-1 xs:gap-10 md:grid-cols-2 xl:grid-cols-2 md:gap-10 lg:gap-5 border-gray-700 border-t-[0.5px]">
