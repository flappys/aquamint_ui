...
export const COLLECTION_API: string = `${constants.BackEnd}/get/marketplace/by-collection/u3FzPGrilVqf1xx1smx6/0`
...
export const COLLECTION=(PARAMS:any) =>{
    return getAPIWithParams("GET", COLLECTION_API, PARAMS)
    }
